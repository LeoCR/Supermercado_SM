...
import com.supermercado.sm.controller.facade.DepartamentoFacade;
...
public class DepartamentoController implements Serializable {
    ...
    @EJB
    private com.supermercado.sm.controller.facade.DepartamentoFacade ejbFacade;
    ...
    public static class DepartamentoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Departamento) {
                ...
                return getStringKey(o.getCodDepartmt());
            } else {
