...
import com.supermercado.sm.controller.facade.ArticuloFacade;
...
public class ArticuloController implements Serializable {
    ...
    @EJB
    private com.supermercado.sm.controller.facade.ArticuloFacade ejbFacade;
    ...
    public static class ArticuloControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Articulo) {
                ...
                return getStringKey(o.getCodArticl());
            } else {
