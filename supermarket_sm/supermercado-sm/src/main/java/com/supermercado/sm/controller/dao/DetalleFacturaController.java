...
import com.supermercado.sm.controller.facade.DetalleFacturaFacade;
...
public class DetalleFacturaController implements Serializable {
    ...
    @EJB
    private com.supermercado.sm.controller.facade.DetalleFacturaFacade ejbFacade;
    ...
    public static class DetalleFacturaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof DetalleFactura) {
                ...
                return getStringKey(o.getNoDetallFact());
            } else {
