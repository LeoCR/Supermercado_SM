...
import com.supermercado.sm.controller.facade.SucursalFacade;
...
public class SucursalController implements Serializable {
    ...
    @EJB
    private com.supermercado.sm.controller.facade.SucursalFacade ejbFacade;
    ...
    public static class SucursalControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sucursal) {
                ...
                return getStringKey(o.getCodSucursl());
            } else {
