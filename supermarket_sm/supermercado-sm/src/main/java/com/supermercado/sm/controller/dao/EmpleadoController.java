...
import com.supermercado.sm.controller.facade.EmpleadoFacade;
...
public class EmpleadoController implements Serializable {
    ...
    @EJB
    private com.supermercado.sm.controller.facade.EmpleadoFacade ejbFacade;
    ...
    public static class EmpleadoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Empleado) {
                ...
                return getStringKey(o.getIdEmpled());
            } else {
